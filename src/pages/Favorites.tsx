    ...
    <div className="space-y-6">
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              Você tem certeza que quer excluir "{productToDelete?.title}"?
            </DialogTitle>
          </DialogHeader>
          <p className="text-gray-600 py-4">
            Esta ação excluirá permanentemente o produto do seu inventário. Você
            poderá desfazer esta ação logo em seguida.
          </p>
          <DialogFooter>
      ...
      {/* Dialog to bulk remove from favorites */}
      <Dialog
      ...
      >
        <DialogContent>
            ...
            {idsToRemove.length === 1 ? (
              <p>
                ...
                <strong>
                  "
                  {
                    favoriteProducts?.find((p) => p.id === idsToRemove[0])
                      ?.title
                  }
                  "
                </strong>{' '}
              ...
              <>
                <p className="mb-2">
                  Você tem certeza que quer remover os{' '}
                  <strong>{idsToRemove.length}</strong> produtos selecionados
                  dos favoritos?
                </p>
          ...
          <DialogFooter>
            ...
            <Button
              variant="destructive"
              onClick={handleBulkRemoveFormFavorites}
            >
              Remover dos Favoritos
            </Button>
          </DialogFooter>
